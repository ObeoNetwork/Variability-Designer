...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>featureDiagram</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureDiagramExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.featurediagram"));
				FeatureDiagram root = FeatureDiagramFactory.eINSTANCE.createFeatureDiagram();

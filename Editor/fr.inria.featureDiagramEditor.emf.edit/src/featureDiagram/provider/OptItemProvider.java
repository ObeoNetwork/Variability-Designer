...
/**
 * This is the item provider adapter for a {@link featureDiagram.Opt} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OptItemProvider
	 ...
	 * @generated
	 */
	public OptItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((Opt)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Opt_type") :
			getString("_UI_Opt_type") + " " + label;
	}

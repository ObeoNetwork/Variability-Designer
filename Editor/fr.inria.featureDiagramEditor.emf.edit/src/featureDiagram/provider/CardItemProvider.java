...
/**
 * This is the item provider adapter for a {@link featureDiagram.Card} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CardItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Card_min_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Card_min_feature", "_UI_Card_type"),
				 FeatureDiagramPackage.Literals.CARD__MIN,
				 true,
				 false,
				 false,
	...
	protected void addMaxPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Card_max_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Card_max_feature", "_UI_Card_type"),
				 FeatureDiagramPackage.Literals.CARD__MAX,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("GlobalOperator.png"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Card.class)) {
			case FeatureDiagramPackage.CARD__MIN:
			case FeatureDiagramPackage.CARD__MAX:
